stanford_path="/data/NeuLF_rgb/stanford_half" #?ç∞?ù¥?Ñ∞?Öã Í≤ΩÎ°ú


test_day="250320_R2L_split_use_combine" #?ã§?óòÍ≤∞Í≥º ?åå?ùº (json?åå?ùº ) Ï§ëÍ∞Ñ ?ù¥Î¶ÑÏùÑ Í≤∞Ï†ï?ï©?ãà?ã§.
result_path="/data/result/${test_day}" #?ã§?óò Í≤∞Í≥º ?åå?ùº ????û• Í≤ΩÎ°ú , Í∏∞Î≥∏?†Å?úºÎ°úÎäî ÏµúÏÉÅ?úÑ data ?è¥?çî?ùò ?ïò?úÑ ?è¥?çîÎ°? Ïß??†ï?êò?ñ¥?ûà?äµ?ãà?ã§.
...
echo "4_run_R2L_split_use_combine start"
for R in "${Rs[@]}"; do
