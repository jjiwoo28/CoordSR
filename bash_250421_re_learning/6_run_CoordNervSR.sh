...
test_day="250330_CoordNervSR_" #?��?��결과 ?��?�� (json?��?�� ) 중간 ?��름을 결정?��?��?��.
...
#datasets=( "knights" )
datasets=("knights" "gem" "bunny" "bracelet" "truck" "treasure" "tarot_small" "tarot"  "flowers" "chess" "bulldozer"  "beans" )
#datasets=( "bracelet" )
...
cnn_types=("nerv_sr256" "nerv_sr256_conv5"  "nerv_sr256_96")
for R in "${Rs[@]}"; do
